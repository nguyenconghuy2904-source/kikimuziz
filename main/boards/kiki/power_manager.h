...
private:
    ...
    std::function<void(bool)> charging_callback_ = nullptr;
    ...
    void CheckBatteryStatus() {
        ...
        // Notify callback if charging state changed
        if (is_charging_ != last_charging_state_) {
            last_charging_state_ = is_charging_;
