...
static const char* GetTwemojiUnicode(const char* emotion) {
    ...
    static const struct {
        ...
        {"neutral", "😶"},      // 0x1f636 - exists in font
        {"natural", "🙂"},      // 0x1f642 - map to happy emoji in font
        {"peaceful", "😌"},     // 0x1f60c - relaxed exists in font
        {"relaxed", "😌"},      // 0x1f60c - exists in font
        {"sleepy", "😴"},       // 0x1f634 - exists in font
        {"tired", "😴"},        // map to sleepy (exists)
        {"bored", "😶"},        // map to neutral (exists)

        // Happy emotions - map to font emojis
        {"happy", "🙂"},        // 0x1f642 - exists in font
        {"laughing", "😆"},     // 0x1f606 - exists in font
        {"funny", "😂"},        // 0x1f602 - exists in font
        {"loving", "😍"},       // 0x1f60d - exists in font
        {"love", "😍"},         // 0x1f60d - exists in font
        {"confident", "😏"},    // 0x1f60f - exists in font
        {"winking", "😉"},      // 0x1f609 - exists in font
        {"wink", "😉"},         // 0x1f609 - exists in font
        {"cool", "😎"},         // 0x1f60e - exists in font
        {"delicious", "🤤"},    // 0x1f924 - exists in font
        {"kissy", "😘"},        // 0x1f618 - exists in font
        {"silly", "😜"},        // 0x1f61c - exists in font
        {"crazy", "😜"},        // map to silly (exists)
        {"excited", "😆"},      // map to laughing (exists)
        {"playful", "😜"},      // map to silly (exists)

        // Sad emotions - map to font emojis
        {"sad", "😔"},          // 0x1f614 - exists in font
        {"crying", "😭"},       // 0x1f62d - exists in font
        {"disappointed", "😔"}, // map to sad (exists)
        {"worried", "😔"},      // map to sad (exists)

        // Angry emotions - map to font emojis
        {"angry", "😠"},        // 0x1f620 - exists in font
        {"frustrated", "😠"},   // map to angry (exists)

        // Surprised emotions - map to font emojis
        {"surprised", "😯"},    // 0x1f62f - exists in font
        {"shocked", "😱"},      // 0x1f631 - exists in font
        {"scared", "😱"},       // map to shocked (exists)

        // Thinking emotions - map to font emojis
        {"thinking", "🤔"},     // 0x1f914 - exists in font
        {"confused", "🙄"},     // 0x1f644 - exists in font
        {"embarrassed", "😳"},  // 0x1f633 - exists in font
        {"nervous", "😳"},      // map to embarrassed (exists)

        // Special states - map to font emojis
        {"sick", "😔"},         // map to sad (exists)
        {"dizzy", "🙄"},        // map to confused (exists)
        {"hungry", "🤤"},       // map to delicious (exists)
