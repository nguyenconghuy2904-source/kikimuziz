...
#include <stdint.h>
#include <stddef.h>
// ESP-IDF compatibility: linux/videodev2.h not available, define constants manually
typedef uint32_t v4l2_pix_fmt_t; // Pixel format type (compatible with V4L2)

// V4L2 pixel format constants (from linux/videodev2.h)
...
#define V4L2_PIX_FMT_YUV422P  v4l2_fourcc('4', '2', '2', 'P')  // 16  YUV 4:2:2 Planar
#define V4L2_PIX_FMT_YUV420   v4l2_fourcc('Y', 'U', '1', '2')  // 12  YUV 4:2:0
#define V4L2_PIX_FMT_JPEG     v4l2_fourcc('J', 'P', 'E', 'G')  //  8  JFIF JPEG

// Helper macro to create fourcc code
